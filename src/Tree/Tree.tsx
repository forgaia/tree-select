...
export interface TreeProps {
  ...
  onDragEnter?: (info: { event: React.MouseEvent; node: EventDataNode; expandedKeys: Key[] }) => void;
  ...
  onDrop?: (info: { event: React.MouseEvent; node: EventDataNode; dragNode: EventDataNode; dragNodesKeys: Key[]; dropPosition: number; dropToGap: boolean }) => void;
  /**
...
class Tree extends React.Component<TreeProps, TreeState> {
  ...
  static getDerivedStateFromProps(props: TreeProps, prevState: TreeState) {
    ...
    if (treeData || newState.expandedKeys) {
      const flattenNodes: FlattenNode[] = flattenTreeData(treeData || prevState.treeData, newState.expandedKeys || prevState.expandedKeys);
  ...
  onNodeCheck = (e: React.MouseEvent<HTMLDivElement>, treeNode: EventDataNode, checked: boolean) => {
